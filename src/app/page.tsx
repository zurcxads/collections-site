    ...
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <span className="text-lg font-semibold tracking-tight">Managed Collections</span>
          <a
            href="#contact"
      ...
      <Section id="how-it-works">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
          ...
          {[
            ...
            { step: 3, icon: Users, title: "Dedicated Team Goes Live", desc: "Trained agents begin outreach within 2 weeks. Your accounts, your rules." },
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ...
                ["Speed", "Live in 2 weeks", "Months to hire & train", "Weeks to months"],
      ...
      <Section id="results">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { number: "2 Weeks", label: "Time to Go Live", desc: "From data handoff to first calls made" },
      ...
      <Section id="technology">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { icon: FileText, title: "Custom Reporting", desc: "Weekly reports tailored to your KPIs. Export anytime." },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-8">
            <div>
              ...
              <a href="mailto:jose@tamezmg.com" className="text-[#2563eb] hover:underline">
                jose@tamezmg.com
              </a>
            </div>
            <div>
              <h3 className="font-semibold mb-1">Phone</h3>
              <a href="tel:+19565782446" className="text-[#2563eb] hover:underline">
                (956) 578-2446
              </a>
            </div>
            <div>
      ...
      <footer className="border-t border-white/[0.06] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="text-sm text-[#888]">© {new Date().getFullYear()} Managed Collections. All rights reserved.</span>
